...
public class ServerApiDelegator {
    ...
    public ServerApiDelegator(String serverName,
        ...
        this.smppIOReactorStorage = new SmppIOReactorStorage();


        // TODO : ThreadPool Implementation and Configurator implementation should be made
        ...
        try {
            ServerIOReactorAccept ioReactorAccept = new ServerIOReactorAccept(serverName,
                                                                              this,
    ...
    public void setApiProperties(ServerApiProperties apiProperties) {
        this.apiProperties = apiProperties;
    }

    public SmppIOReactorStorage getSmppIOReactorStorage() {
