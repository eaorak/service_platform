...
public class ServerMessageHandler implements ISmppMessageHandler {
    ...
    public ServerMessageHandler(ServerIOReactor ioReactor) {
        this.ioReactor = ioReactor;
    }

    @Override
    public void handleMsg(ByteBuffer byteBuffer) throws Exception {
        ...
        switch (header.getCommandID()) {
            ...
            case Smpp34Constants.MSG_SUBMIT_SM:
                this.submitSMHandler.handle(header, byteBuffer, this.ioReactor);
                break;
