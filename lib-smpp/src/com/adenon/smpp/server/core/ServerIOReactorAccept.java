...
public class ServerIOReactorAccept extends Thread {
    ...
    public ServerIOReactorAccept(String serverName,
                                 ServerApiDelegator serverApiDelegator,
                                 ServerApiProperties apiProperties,
                                 LoggerWrapper logger,
                                 SmppIOReactorStorage smppIOReactorStorage) throws Exception {
    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                try {
                    ServerLogManager logManager = this.serverApiDelegator.getLogManager();
                    ...
                    ServerIOReactor serverIOReactor = new ServerIOReactor(clogger,
                                                                          this.serverName,
