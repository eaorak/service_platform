...
public class ServerApiProperties {
    ...
    public ServerApiProperties setPort(int port) {
        this.port = port;
        return this;
    }
    ...
    public ServerApiProperties setWindowSize(int windowSize) {
    ...
    public ServerApiProperties setMaxThreadCount(int maxThreadCount) {
    ...
    public ServerApiProperties setTraceOn(boolean traceOn) {
