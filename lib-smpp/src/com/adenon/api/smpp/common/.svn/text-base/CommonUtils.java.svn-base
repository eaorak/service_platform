...
public class CommonUtils {
    ...
    public static int getIndex(final char car) throws SmppApiException {
        for (int i = 0; i < nibbleToChar.length; i++) {
            if (car == nibbleToChar[i]) {
                return i;
            }
        }
    ...
    public static String relativeTimeStringFromMinutes(final int minutes) throws Exception {
        long miliseconds = ETime.MINUTE.getMiliseconds(minutes);
        return relativeTimeStringFromMiliseconds(miliseconds);
    }

    public static String relativeTimeStringFromSeconds(final long seconds) throws Exception {
        long miliseconds = ETime.SECOND.getMiliseconds(seconds);
        return relativeTimeStringFromMiliseconds(miliseconds);
    }
    ...
    public static long milisecondsFromRelativeString(String relativeString) {
        String year = relativeString.substring(0, 2);
        String month = relativeString.substring(2, 4);
        String day = relativeString.substring(4, 6);
        String hour = relativeString.substring(6, 8);
        String minute = relativeString.substring(8, 10);
        String second = relativeString.substring(10, 12);
