...
public class LogController {
    ...
    public LogController(String instanceName,
    ...
    public void initiliaze() {
        ...
        if (existLogger != null) {
            ...
            logWrappers.put(this.engineName, retlogger);
    ...
    public LoggerWrapper getLogger(final String loggerName) {
        LoggerWrapper retlogger = logWrappers.get(loggerName);
        if (retlogger != null) {
            return retlogger;
        }
        ...
        retlogger = logCreator.getlogger(this.engineName);
        if (this.logDescriptor.isWriteConsole()) {
            retlogger = new LogToConsole().setLevel(this.logDescriptor.getLevel()).getlogger(this.engineName);
        }
        logWrappers.put(this.engineName, retlogger);
        return retlogger;
    }
