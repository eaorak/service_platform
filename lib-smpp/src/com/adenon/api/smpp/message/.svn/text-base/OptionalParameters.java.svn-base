...
public class OptionalParameters extends MandatoryParameters {
    ...
    public void parseOpitionalParameters(final ByteBuffer byteBuffer,
        ...
        try {
            while (byteBuffer.limit() > byteBuffer.position()) {
                ...
                switch (parameterTag) {
                    ...
                    case Smpp34Constants.OPT_USSD_SERVICE_OP:
                        this.setOpParamUSSDServiceOp(CommonUtils.getIntegerWithLen(parameterLength, byteBuffer));
                        break;
                    ...
                    case Smpp34Constants.OPT_MSG_STATE:
                        ...
                        break;
                    default:
                        this.logger.warn("OptionalParameters", "parseOpitionalParameters", transID, label, " Unsupported optional parameter id : "
                                                                                                           + parameterTag);
            ...
            this.logger.error("SubmitSMMessage", "getOpParams", transID, label, " : Error : " + e.getMessage(), e);
        }
    ...
    public void fillOptionalParameters(final ByteBuffer byteBuffer) throws Exception {
        ...
        if (this.getOpParamUSSDServiceOp() >= 0) {
            CommonUtils.putByteToOptBuffer(Smpp34Constants.OPT_USSD_SERVICE_OP, (byte) this.getOpParamUSSDServiceOp(), byteBuffer);
        }
        if (!CommonUtils.checkStringIsEmpty(this.getOpParamMessageId())) {
            CommonUtils.putCStringBytesToOptBuffer(Smpp34Constants.OPT_RECEIPTED_MESSAGE_ID, this.getOpParamMessageId().getBytes("iso8859-1"), byteBuffer);
        }
    ...
    public ArrayList<OptionalParameter> getOptParamsList() {
        return this.optParamsList;
    }

    public void setOptParamsList(final ArrayList<OptionalParameter> optParamsList) {
    ...
    public void setOpParamMessageId(String opParamMessageId) {
    ...
    public void setPutConcatOptionalParameters(boolean putConcatOptionalParameters) {
