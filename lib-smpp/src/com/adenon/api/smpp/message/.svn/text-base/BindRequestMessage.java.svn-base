...
public class BindRequestMessage {
    ...
    private byte               interfaceVersion = CommonUtils.INTERFACE_VERSION;
    ...
    public void parseMessage(final ByteBuffer byteBuffer) throws Exception {
        ...
        this.setSystemIdentifier(new String(temp, 0, charCount));
        charCount = CommonUtils.getCOctetString(temp, byteBuffer);
        this.setPassword(new String(temp, 0, charCount));
        CommonUtils.getCOctetString(temp, byteBuffer);
        this.setUsername(new String(temp, 0, charCount));
    ...
    public void fillBody(final ByteBuffer byteBuffer,
        ...
        if (this.getUsername() != null) {
            byteBuffer.put(this.getUsername().getBytes("ISO8859-1"));
        }
        byteBuffer.put((byte) 0);
        byteBuffer.put((byte) 0);
