...
@MBean(location = ConfigLocation.CHANNELS, subLocation = "SmsAdapter=SMSSERVER,logging=Log", persist = true)
public class LoggerBean {
    ...
    private ServerLoggerApi  serverLoggerApi;
    ...
    public LoggerBean(ServerLoggerApi serverLoggerApi) {
        this.serverLoggerApi = serverLoggerApi;
    }
    ...
    public ServerLoggerApi getSmppLoggerApi() {
        return this.serverLoggerApi;
    }

    public void setSmppLoggerApi(ServerLoggerApi smppLoggerApi) {
        this.serverLoggerApi = smppLoggerApi;
    }

    @Attribute
    public boolean getTraceOpen() {
